...
QT_MOC_LITERAL(1, 11, 21), // "modificarTodosClicked"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 22) // "slotCambiarNombreBoton"

    },
    "DExamenTab\0modificarTodosClicked\0\0"
    "slotCambiarNombreBoton"
};
...
void DExamenTab::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DExamenTab *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->modificarTodosClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->slotCambiarNombreBoton(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DExamenTab::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DExamenTab::modificarTodosClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DExamenTab::modificarTodosClicked(int _t1)
{
