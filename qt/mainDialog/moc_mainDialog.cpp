...
QT_MOC_LITERAL(1, 11, 12), // "slotBackward"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 3), // "str"
QT_MOC_LITERAL(4, 29, 19), // "Qt::CaseSensitivity"
QT_MOC_LITERAL(5, 49, 2), // "cs"
QT_MOC_LITERAL(6, 52, 12) // "slotFordward"

    },
    "MainDialog\0slotBackward\0\0str\0"
    "Qt::CaseSensitivity\0cs\0slotFordward"
};
...
void MainDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotBackward((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< Qt::CaseSensitivity(*)>(_a[2]))); break;
        case 1: _t->slotFordward((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< Qt::CaseSensitivity(*)>(_a[2]))); break;
        default: ;
        }
    }
}
