...
QT_MOC_LITERAL(1, 11, 23), // "botonNuevoWidgetClicked"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 16), // "slotTemporizador"
QT_MOC_LITERAL(4, 53, 13), // "slotBotonNext"
QT_MOC_LITERAL(5, 67, 13) // "slotBotonPrev"

    },
    "WidgetInfo\0botonNuevoWidgetClicked\0\0"
    "slotTemporizador\0slotBotonNext\0"
    "slotBotonPrev"
};
...
void WidgetInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->botonNuevoWidgetClicked((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 1: _t->slotTemporizador(); break;
        case 2: _t->slotBotonNext(); break;
        case 3: _t->slotBotonPrev(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WidgetInfo::*)(int , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WidgetInfo::botonNuevoWidgetClicked)) {
                *result = 0;
                return;
            }
        }
...
void *WidgetInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::WidgetInfo"))
        return static_cast< Ui::WidgetInfo*>(this);
...
// SIGNAL 0
void WidgetInfo::botonNuevoWidgetClicked(int _t1, bool _t2)
{
