...
QT_MOC_LITERAL(1, 13, 16), // "slotTablaClicked"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 11) // "QModelIndex"

    },
    "DialogoTabla\0slotTablaClicked\0\0"
    "QModelIndex"
};
...
void DialogoTabla::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DialogoTabla *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotTablaClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    }
}
